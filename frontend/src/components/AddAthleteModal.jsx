...
const AddAthleteModal = ({ teams, onClose, onSubmit }) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 bg-slate-800/50 border ${errors.team_id ? 'border-red-500' : 'border-slate-700'} rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-brand-cyan`}
                >
                ...
                {errors.team_id && (
                  <p className="mt-2 text-sm text-red-400">{errors.team_id}</p>
                )}
              </div>
